...
@section('content')
    ...
    <p>Pursuant to DP002 6.1.8 - All transfer requests will be processed as expeditiously as possible. At the discretion
        of the
        appropriate Air Traffic Director, transfer requests may be approved or denied by the Air Traffic Director if the
        ATM has
    ...
    <p>You can access your pending transfers here: https://www.vatusa.net/mgt/facility/{{$gaining}}#trans<br>Member
        profile: https://www.vatusa.net/mgt/controller/{{$cid}}</p>
@endsection