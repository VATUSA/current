...
@section('scripts')
    <script>
      ...
      $('#toggleDMT').click(function () {
          ...
          $.ajax({
              type: 'POST',
              url : "{{ secure_url("/mgt/controller/ajax/toggleDMTRole") }}",
              data: {cid: "{{ $user->cid }}"}
          }).success(function (result) {
              spinner.hide()
              if (result === '1') {
                  ...
                  bootbox.alert('<div class=\'alert alert-danger\'><i class=\'fa fa-warning\'></i> <strong>Error!</strong> Unable to toggle VATUSA Discord Moderation Team role.')
              }
          })
              .error(function (result) {
                  spinner.hide()
