      ...
      $('#toggleDCC').click(function () {
          ...
          $.ajax({
              ...
              if (result === '1') {
                  ...
                  bootbox.alert('<div class=\'alert alert-danger\'><i class=\'fa fa-warning\'></i> <strong>Error!</strong> Unable to toggle VATUSA DCC role.')
              }
          })
              .error(function (result) {
                  spinner.hide()
                        ...
                        <div class="tab-pane" role="tabpanel" id="roles">
                            ...
                            @else
                                @if(\App\Classes\RoleHelper::isVATUSAStaff())
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">VATUSA DCC Staff</label>
                                        <div class="col-sm-10">
                                            <span id="toggleDCC" style="font-size:1.8em;">
                                                <i class="toggle-icon fa fa-toggle-{{ \App\Classes\RoleHelper::hasRole($user->cid, "ZHQ", "DCC") ? "on text-success" : "off text-info"}} "></i>
                                                <i class="spinner-icon fa fa-spinner fa-spin" style="display:none;"></i>
                                            </span>
                                            <p class="help-block">This will allow the user to receive the proper roles
                                                in Discord.</p>
