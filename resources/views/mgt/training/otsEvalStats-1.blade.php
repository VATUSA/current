                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($tableData as $data)
                                            <tr>
                                                ...
                                                <td><span class="text-success" rel="tooltip" title="Past 30 days">{{ $data['numPasses'][30] }}</span>/
                                                    <span class="text-success" rel="tooltip" title="Past 60 days">{{ $data['numPasses'][60] }}</span>/
                                                    <span class="text-success" rel="tooltip" title="Past 90 days">{{ $data['numPasses'][90] }}</span>
                                                <br>
                                                <span class="text-danger" rel="tooltip" title="Past 30 days">{{ $data['numFails'][30] }}</span>/
                                                    <span class="text-danger" rel="tooltip" title="Past 60 days">{{ $data['numFails'][60] }}</span>/
                                                    <span class="text-danger" rel="tooltip" title="Past 90 days">{{ $data['numFails'][90] }}</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    ...
                                    <select class="form-control" id="instructor-select" name="instructor">
                                        @if($facility)
                                            ...
                                            @foreach($allIns as $ins)
                                                <option value="{{ $ins['cid'] }}" @if($instructor == $ins) selected @endif>
                                                    {{ $ins['name'] }}
                                                </option>
                                            @endforeach
                                        @else
