                        ...
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <p class="help-block">To change your name, contact the <a
                                            href="https://support.vatsim.net/"> VATSIM Membership Department</a>. If you
                                        would like your name changed on VATUSA while it is being processed by VATSIM,
                                        send an email to VATUSA12.</a></p>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <span id="toggleOptin" style="font-size:1.8em;">
                                ...
                                <i class="spinner-icon fa fa-spinner fa-spin" style="display:none;"></i>
                                    ...
                                    <p class="help-block">To receive emails from the VATUSA mass emailing system, you
                                        must opt-in by clicking on the toggle switch above. <br>This only affects the
                                        mass emailing
                                        system of ARTCCs that choose to use this response.<br><strong>This setting does
                                            not affect
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <p class="help-block"><strong>You will automatically join the Discord
                                            server.</strong><br>
                                        Once joined and linked, you may assign your roles by clicking "Assign Roles."
                                    </p>
                                </div>
                            </div>
                        </form>
