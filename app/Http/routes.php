...
Route::group(['domain' => 'api.vatusa.net', 'middleware' => 'api'], function () {
    ...
    Route::get('events.{ext},{limit}', 'APIController@getPublicEvents')->where([
        'ext'   => '[A-Za-z]+',
        'limit' => '\d+'
    ]);
    ...
    Route::get('events,{limit}.{ext}', 'APIController@getPublicEvents')->where([
        'ext'   => '[A-Za-z]+',
        'limit' => '\d+'
    ]);
    Route::get('events', 'APIController@getPublicEvents')->where(['ext' => '[A-Za-z]+', 'limit' => '\d+']);

    Route::get('roster-{fac}.{ext},{limit}', 'APIController@getPublicRoster')->where([
        'fac'   => '[A-Z][A-Z][A-Z]',
        'ext'   => '[A-Za-z]+',
        'limit' => '\d+'
    ]);
    Route::get('roster-{fac},{limit}', 'APIController@getPublicRoster')->where([
        'fac'   => '[A-Z][A-Z][A-Z]',
        'ext'   => '[A-Za-z]+',
        'limit' => '\d+'
    ]);
    Route::get('roster-{fac}.{ext}', 'APIController@getPublicRoster')->where([
        'fac'   => '[A-Z][A-Z][A-Z]',
        'ext'   => '[A-Za-z]+',
        'limit' => '\d+'
    ]);
    Route::get('roster-{fac},{limit}.{ext}', 'APIController@getPublicRoster')->where([
        'fac'   => '[A-Z][A-Z][A-Z]',
        'ext'   => '[A-Za-z]+',
        'limit' => '\d+'
    ]);
    Route::get('roster-{fac}', 'APIController@getPublicRoster')->where([
        'fac'   => '[A-Z][A-Z][A-Z]',
        'ext'   => '[A-Za-z]+',
        'limit' => '\d+'
    ]);
